        ...
        <div class="container-fluid">
            ...
            <div class="row" id="main" >
                <div class="col-sm-12 col-md-12 well" id="content">
                    <form:form modelAttribute="newAccount" action="newAccountProcess" method="POST">
                        ...
                        <form:select path="accType">
                            <form:option value="C" label="Current A/C"/>
                            <form:option value="F" label="Fixed A/C"/>
                            <form:option value="S" label="Savings A/C"/>
                        </form:select>
