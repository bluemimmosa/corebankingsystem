...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Core Banking System : Search Accounts By Name</title>
        ...
        <div class="container-fluid">
            ...
            <div class="row" id="main" >
                <div class="col-sm-12 col-md-12 well" id="content">
                    <form:form modelAttribute="search" action="searchProcess" method="POST">
                    <h1>Search by Name:</h1>
                    <p> Please enter your name to search.</p> 
                    <form:input type="text" path="name" name="name" placeholder="Account Name"/> 
                        ...
                        <%
                            ...
                            for(Account a: accLists){ %>
                                <tr>
                                    ...
                                    <td><a class="btn btn-danger" href="delete?accNo=<%out.print(a.getAccNo());%>"><span class="text">Remove</span></a>
                                </tr>
                                <%
                            }
                        %>
